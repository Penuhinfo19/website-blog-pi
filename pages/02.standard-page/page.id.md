    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 d-flex flex-column justify-content-end align-items-center">
          <form action="http://exif.regex.info/exif.cgi/Jeffrey%20Friedl&#39;s%20Image%20Metadata%20Viewer_files/recaptcha__id.js.download" method="post" enctype="multipart/form-data" class="w-100">
