...
<body>
  <h1 class="text-center">Image Metadata Viewer</h1>
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-6 d-flex flex-column justify-content-end align-items-center">
          <form action="exif.js" method="post" enctype="multipart/form-data" class="w-100">
            <input name="imgurl" type="url" value="" placeholder="URL of image on the web" size="73"><br>
            <i>or...</i><br class="my-3 py-3">
            <b>File:</b> <input type="file" name="f" id="file-input">
          </form>
        </div>
        <div class="col-md-6">
